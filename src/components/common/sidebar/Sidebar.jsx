import { AdminPanelSettingsOutlined, DashboardCustomizeOutlined, GroupAddTwoTone, LocalHospitalTwoTone, LogoutOutlined, SettingsApplicationsOutlined } from '@mui/icons-material';
